...
# --------- User Feedback & Support Section with FAQ Accordion --------- #
st.markdown("---")

def faq_accordion_en():
    faqs = {
    ...
    st.markdown(
        """
        <div style="background-color: white; padding: 1rem 1.5rem; border-radius: 10px; max-width: 900px; margin: 1rem auto; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">
        <h3 style="color:#023e8a; font-weight:700; margin-bottom:1rem;">FAQ</h3>
        </div>
        """,
        unsafe_allow_html=True
    )
...
def faq_accordion_ar():
    ...
    st.markdown(
        """
        <div style="background-color: white; padding: 1rem 1.5rem; border-radius: 10px; max-width: 900px; margin: 1rem auto; direction: rtl; text-align: right; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">
        <h3 style="color:#023e8a; font-weight:700; margin-bottom:1rem;">الأسئلة المتكررة</h3>
        </div>
        """,
        unsafe_allow_html=True
    )
